<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ session('selected_website_domain') ?? '#' }}" target="_blank">
            ...
            @endif
            <span class="ms-1 font-weight-bold">{{ session('selected_website_name') ?? 'Pinjam Buku' }}</span>
        </a>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if (request()->is('pinjam')) active @endif" href="{{ route('pinjam.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link @if (request()->is('users')) active @endif" href="{{ route('user.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link @if (request()->is('buku')) active @endif" href="{{ route('buku.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-book-bookmark" style="color: black;"></i>
                    </div>
                    <span class="nav-link-text ms-1">Master Buku</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (request()->is('pengajuan')) active @endif" href="{{ route('pengajuan.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-calendar-grid-58" style="color: black;"></i>
                    </div>
                    <span class="nav-link-text ms-1">Pengajuan Buku</span>
                </a>
            </li>
            @endif
    ...
    {{-- <div class="sidenav-footer mx-3 ">
        ...
        <a class="btn btn-success mt-3 w-100"
